        ...
        <div className="home">
            ...
            <div className="mb-6">
              <div className="grid grid-cols-2 gap-4 mt-8 items-center">
                  <div className="max-w-sm rounded overflow-hidden shadow-lg h-[580px]">
                  <div className="relative flex h-32 w-full justify-center rounded-xl bg-cover" >
                    ...
                    <div className="px-6 py-4 text-center">
                      ...
                      <p className="dark:text-teal-400 text-teal-500 mt-1">
                  ...
                  <div className="relative flex h-32 w-full justify-center rounded-xl bg-cover" >
                    ...
                    <div className="px-6 py-4 text-center">
                      ...
                      <p className="dark:text-teal-400 text-teal-500">
                      Languages I speak:
                      </p>
